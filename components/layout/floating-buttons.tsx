...
export function FloatingButtons() {
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
      {/* WhatsApp */}
      <a
        href="https://wa.me/5566992605476?text=Olá! Tenho interesse em ser franqueado Preventec."
        target="_blank"
      ...
      >
        <span className="hidden group-hover:block text-sm font-medium pl-4 whitespace-nowrap">
          WhatsApp
        </span>
