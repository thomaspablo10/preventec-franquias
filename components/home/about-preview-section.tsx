        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              A Preventec Franquias nasceu da experiência acumulada de mais de 28 anos no setor de Medicina e Segurança do Trabalho. Fundada em 1998, desenvolvemos um modelo de franquia robusto que permite empreendedores de todo o Brasil oferecer serviços de alta qualidade com processos padronizados.
            </p>
